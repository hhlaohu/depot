...
tip.css("left",box.offset().left-tip._outerWidth()-12);
tip.addClass("validatebox-tip-left");
}else{
tip.css("left",box.offset().left+box._outerWidth()+12);
...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"该字段不能为空.",invalidMessage:null,tipPosition:"right",rules:{email:{validator:function(_26){
...
},message:"请输入有效邮箱地址."},url:{validator:function(_27){
...
},message:"请输入有效的 URL."},length:{validator:function(_28,_29){
var len=$.trim(_28).length;
return len>=_29[0]&&len<=_29[1];
},message:"请输入 {0} 到 {1}的值."},remote:{validator:function(_2a,_2b){
var _2c={};
_2c[_2b[1]]=_2a;
