...
<body>
	<div class="warp easyui-panel" data-options="border:false">
		...
		<!-- Edit Form -->
		<div id="edit-win" class="easyui-dialog" title="用户管理"
			...
			<form id="editForm" class="ui-form" method="post">
				...
				<div class="ui-edit">
					...
					<div class="fitem">
						<label>电话号码:</label> <input class="easyui-validatebox" type="text"
							name="tel">
					</div>
					<div class="fitem">
					...
					<div class="fitem">
						<label>是否发送短信:</label> <select class="easyui-combobox"
							name="is_send_message" data-options="required:true,width:150">
