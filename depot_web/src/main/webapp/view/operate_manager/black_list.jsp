...
<head>
    ...
    <script type="text/javascript" src="${msUrl}/js/ux/operate_manager/black_list.js"></script>
</head>
<body>
...
<div class="warp easyui-panel" data-options="border:false">
    ...
    <%--新增黑名单弹窗 start--%>
    <div id="edit-win" class="easyui-dialog" title="新增黑名单" buttons="#addFormBtn"
         data-options="closed:true,iconCls:'icon-save',modal:true" style="width: 400px; height: 175px;">
        <form id="editForm" class="ui-form" method="post">
            <!-- 隐藏文本框 -->
            <input class="hidden" name="black_list_id">
            <div class="ui-edit">
                <div class="fitem">
                    <label>所属区域:</label>
